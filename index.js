...
const elementsFromHomePage = [
  { className: ".main-img", value: "none" },
  { className: ".content", value: "none" },
  { className: ".top-img", value: "none" },
];
const elementsToHomePage = [
  { className: ".content-card", value: "none" },
  { className: ".single-img-wrapper", value: "none" },
  { className: ".main-img", value: "block" },
  { className: ".content", value: "block" },
  { className: ".top-img", value: "block" },
];
const backGroundsToHomePage = [
  { className: ".wrapper", value: "#161010" },
  { className: ".circle", value: "#94ceed" },
];
...
const cards = [
  {
    ...
    img: "img/card1.png",
    description:
      "It was popularised in the 1960s with the release of Letroset sheets " +
...
exploreBtn.addEventListener("click", () => {
  ...
  gsap.fromTo(
    ".content-card",
    { y: 300, opacity: 0 },
    { display: "block", duration: 2, y: 0, opacity: 1 }
  );
  gsap.fromTo(
    ".top-img",
    { y: 0, opacity: 1 },
  ...
  gsap.fromTo(
    ".single-img-wrapper",
    { y: 600, x: 600, transform: "skew(15deg, -15deg)", opacity: 0 },
    {
      duration: 0.5,
      display: "flex",
      y: 0,
...
carouselBtn.addEventListener("click", () => {
  ...
  if (currentCardSrc === cards[cards.length - 1].img) {
    ...
    gsap.fromTo(
      cardNext,
      { y: 600, x: 600, opacity: 0 },
      { duration: 1, display: "flex", y: 0, x: 0, opacity: 1 }
    );
    gsap.fromTo(
      card,
      { y: 180, x: 550, opacity: 1 },
      {
        duration: 1,
        display: "flex",
        y: 0,
...
function backgroundColor(elements) {
  elements.forEach(
    (element) =>
      (document.querySelector(element.className).style.backgroundColor =
        element.value)
  );
}
...
function displayShow(elements) {
  elements.forEach(
    (element) =>
      (document.querySelector(element.className).style.display = element.value)
  );
}
...
function backgroundAnimation(param) {
  ...
  gsap.fromTo(
    ".circle",
    { y: 500, x: -500, opacity: 0, padding: 30 },
